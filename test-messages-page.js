...
jest.mock('./src/lib/contactMessagesAPI', () => ({
  getContactMessages: jest.fn(() => Promise.resolve({
    success: true,
    data: [
      {
        id: 1,
  ...
  markMessageAsReplied: jest.fn(() => Promise.resolve({
    success: true,
    data: { id: 1, isReplied: true },
    message: 'Message marked as replied'
  })),
  deleteContactMessage: jest.fn(() => Promise.resolve({
    success: true,
    data: null,
    message: 'Message deleted successfully'
  })),
  sendReply: jest.fn(() => Promise.resolve({
    success: true,
    data: null,
...
describe('Messages Page', () => {
  test('renders messages page with correct title', () => {
    ...
    expect(screen.getByText('Manage contact form messages and replies')).toBeInTheDocument();
  });
...
console.log('  ✓ POST /api/ContactMessages/{id}/mark-replied - Mark as replied');
console.log('  ✓ POST /api/ContactMessages/{id}/mark-unreplied - Mark as unread');
...
console.log('');
console.log('🚀 Ready to use! Navigate to /admin/messages to see the new feature.');
