...
const CTASection = ({ 
  ...
  const finalData = {
    ...
    subtitle: subtitle || "",
    description: description || "Join 10,000+ companies that have automated their HR processes and reduced administrative workload by 70%",
  ...
  return (
    <section className="py-16 bg-gray-50 text-center animate-fade-in-up light-section">
      <div className="max-w-2xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-blue-800">{finalData.title}</h2>
        {finalData.subtitle && (
          <h3 className="text-lg md:text-xl text-blue-600 mb-4 leading-relaxed">{finalData.subtitle}</h3>
        )}
        <p className="text-lg md:text-xl mb-8 text-gray-600">{finalData.description}</p>
