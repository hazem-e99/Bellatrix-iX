      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            {footerData.company_tagline && (
              <p className="text-gray-400 text-sm">{footerData.company_tagline}</p>
            )}
            {footerData.company_address && (
              <p className="text-gray-400 text-sm">{footerData.company_address}</p>
            )}
            <div className="space-y-2 text-sm">
              {footerData.company_email && (
                <p className="text-gray-400">
                  <span className="font-medium">Email:</span>{" "}
                  <a href={`mailto:${footerData.company_email}`} className="hover:text-blue-400 transition-colors">
                    {footerData.company_email}
                  </a>
                </p>
              )}
              {footerData.company_phone && (
                <p className="text-gray-400">
                  ...
                  <a href={`tel:${footerData.company_phone}`} className="hover:text-blue-400 transition-colors">
                    {footerData.company_phone}
                  </a>
                </p>
              )}
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} {footerData.company_name || "Your Company"}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
