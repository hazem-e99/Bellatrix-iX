...
const CTASection = ({ 
  ...
  const propsData = { title, subtitle, description, ctaButton, features, trustedBy };
  ...
  const mergedData = {
    title: finalData.title || title || "Transform Your Manufacturing Operations",
    subtitle: finalData.subtitle || subtitle || "",
    description: finalData.description || description || "Join hundreds of manufacturing companies that have optimized their operations with our solutions.",
    buttonText: finalData.buttonText || ctaButton?.text || "Get Started",
    buttonLink: finalData.buttonLink || ctaButton?.link || "/manufacturing/contact",
    variant: finalData.variant || ctaButton?.variant || "primary",
    features: finalData.features || features || [
      {
      ...
      <div className="container mx-auto px-6">
        <div className="bg-gradient-to-r from-gray-100 to-gray-200 rounded-3xl p-12 text-gray-800 text-center border border-gray-300">
          <div className="max-w-4xl mx-auto">
            ...
            {mergedData.subtitle && (
              <h3 className="text-xl md:text-2xl text-gray-800 mb-4 leading-relaxed">{mergedData.subtitle}</h3>
            )}
