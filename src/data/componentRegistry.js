...
export const componentRegistry = {
  ...
  LandingPage: {
    Hero: {
      ...
      description: "Main hero section with video backgrounds, slides, and stats",
      dataStructure: {
  ...
  HR: {
    HRHeroSection: {
      ...
      category: "hero",
      icon: "👥",
      description: "HR solution hero section with title, subtitle, and description", 
      dataStructure: {
        title: "string",
        subtitle: "string",
        description: "string",
        ...
        faq: {
          ...
          items: [
            { 
              ...
              answer: "Yes. We use enterprise-grade 256-bit encryption, regular security audits, and are fully GDPR, SOC 2, and ISO 27001 compliant." 
            },
            { 
              question: "Can I integrate with my existing payroll and accounting software?", 
              answer: "Absolutely. We offer pre-built integrations with all major payroll providers and accounting software." 
            },
            { 
              question: "How long does implementation typically take?", 
              answer: "Implementation time varies based on complexity: Essential (2-3 weeks), Professional (3-5 weeks), Enterprise (6-8 weeks)." 
            }
          ]
        },
        faqItems: [
...
export const getComponentsByPageType = (pageType) => {
  return componentRegistry[pageType] ? Object.values(componentRegistry[pageType]) : [];
};
